  ...
  return (
    <Overlay dim={0.7}>
      <div style={{ textAlign: 'center', fontFamily: 'Inter, Pretendard, sans-serif' }}>
        ...
        <div style={{ fontSize: 44, fontWeight: 900, marginTop: 8, marginBottom: 6, letterSpacing: '0.08em' }}>SIGNAL LOST</div>
        <div style={{ fontSize: 13, opacity: 0.55, marginBottom: 28 }}>픽셀의 신호가 끊어졌습니다 — 목숨 소진</div>
